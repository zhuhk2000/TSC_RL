...
if __name__ == "__main__":
    ...
    prs.add_argument(
        ...
        dest="route",
        type=str,
        default="D:/Anaconda/envs/RL/Lib/site-packages/sumo_rl/nets/single-intersection/single-intersection.rou.xml",
    ...
    env = SumoEnvironment(
        net_file="D:/Anaconda/envs/RL/Lib/site-packages/sumo_rl/nets/single-intersection/single-intersection.net.xml",
